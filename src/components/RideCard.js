    ...
    <article class="card ride-card" id="ride-${ride.id}" style="margin-bottom:1.25rem;">
      <div style="display:flex; justify-content:space-between; align-items:flex-start; flex-wrap:wrap; gap:1rem; margin-bottom:1rem;">
        ...
        <div style="display:flex; align-items:center; gap:0.85rem;">
          ...
          <div>
            <div style="display:flex; align-items:center; gap:0.5rem;">
              <h3 style="font-family:var(--font-subtitle); font-size:1.15rem; text-transform:none;">${ride.motoristaNome}</h3>
              <span class="badge badge-amarelo" style="font-size:0.8rem;">? ${ride.motoristaAvaliacao.toFixed(1)}</span>
            </div>
            <p style="font-size:0.92rem; color:var(--text-muted);">${ride.motoristaCurso} · ${ride.veiculo} (${ride.cor})</p>
          </div>
        </div>
        ...
        <div style="display:flex; align-items:center; gap:0.65rem; text-align:right;">
          ...
          <div style="font-family:var(--font-subtitle); font-size:1.25rem; color:var(--text-primary);">
      ...
      <div style="background-color:var(--bg-primary); padding:1rem 1.25rem; border-radius:var(--radius-md); border:1px solid var(--border-color); margin-bottom:1.15rem;">
        <div style="font-family:var(--font-title); font-size:0.95rem; color:var(--text-muted); margin-bottom:0.4rem; letter-spacing:0.02em;">
